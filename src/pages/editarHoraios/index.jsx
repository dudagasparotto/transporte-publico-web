...
export default function EditarHorarios() {
  ...
  const [pontoIndexSelecionado, setPontoIndexSelecionado] = useState(null);
  ...
  const deletarLinha = (index) => {
    ...
    copia[linhaSelecionada].pontos =
      copia[linhaSelecionada].pontos.filter((_, i) => i !== index);
        ...
        <div className={styles.overlay}>
          <div className={styles.modal}>
            ...
            <input
              ...
              value={nomeNovoPonto}
              onChange={(e) =>
                setNomeNovoPonto(e.target.value)
              }
            />
